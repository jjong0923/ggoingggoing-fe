...
export function ShowcaseLayout({ children, phone }: ShowcaseLayoutProps) {
  return (
    <div className="relative overflow-hidden px-4 py-6 md:px-8 md:py-8">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-6rem)] max-w-7xl gap-8 xl:grid-cols-[1.05fr_0.95fr] xl:items-start">
        <section className="flex flex-col justify-center px-2 py-4 md:px-6 xl:pt-8">
          {children}
        </section>

        <section className="mx-auto flex w-full max-w-[430px] justify-center pt-2 xl:justify-end xl:pt-8">
          {phone}
        </section>
      </div>
    </div>
